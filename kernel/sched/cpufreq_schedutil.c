...
<<<<<<< HEAD
	...
	if (likely(use_pelt()))
		sg_policy->work_in_progress = false;
||||||| parent of 862a729d95cfb... schedutil: Allow cpufreq requests to be made even when kthread kicked

	if (use_pelt())
		sg_policy->work_in_progress = false;
=======
>>>>>>> 862a729d95cfb... schedutil: Allow cpufreq requests to be made even when kthread kicked
}
